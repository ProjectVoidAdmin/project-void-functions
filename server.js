    ...
    switch (msg.type) {
      ...
      case "admin_get_player": {
        ...
        try {
          ...
          send(ws, { type:"admin_player_data", targetUid, username, player });
        } catch (e) {
      ...
      case "admin_reset_gold": {
        ...
        try {
          ...
          flagAnomaly(rgUid, "admin_reset_gold", { by: clientUid, amount: amount || 0 });
      ...
      case "admin_wipe_inventory": {
        ...
        try {
          ...
          flagAnomaly(wiUid, "admin_wipe_inventory", { by: clientUid });
      ...
      case "admin_wipe_actions": {
        ...
        try {
          ...
          flagAnomaly(waUid, "admin_wipe_actions", { by: clientUid });
